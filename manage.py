...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if model_path:
        ...
        from parts.line_follower import LineFollower
        cv_pilot = LineFollower()
        V.add(cv_pilot, inputs=['cam/image_array'], outputs=['pilot/angle', 'pilot/throttle'], run_condition='run_pilot')
