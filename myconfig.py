...
PWM_STEERING_THROTTLE = {
	"PWM_STEERING_PIN": "PCA9685.1:40.0",   # Pin for steering servo
	"PWM_STEERING_SCALE": 1.0,              # PWM frequency compensation
	"PWM_STEERING_INVERTED": False,         # Invert steering direction
	"PWM_THROTTLE_PIN": "PCA9685.1:40.1",   # Pin for ESC (Throttle)
	"PWM_THROTTLE_SCALE": 1.0,              # PWM frequency compensation
	"PWM_THROTTLE_INVERTED": False,         # Invert throttle direction
	"STEERING_LEFT_PWM": 480,               # Calibrated value: Full Left
	"STEERING_RIGHT_PWM": 330,              # Calibrated value: Full Right
	"THROTTLE_FORWARD_PWM": 405,            # Max Forward PWM was 500
	"THROTTLE_STOPPED_PWM": 370,            # Calibrated value: Stopped
	"THROTTLE_REVERSE_PWM": 320,            # Max Reverse PWM was 220
}
